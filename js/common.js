...
/*
* 判断当前浏览器。
* @navigator    是一个独立的对象，他用于提供用户所使用的浏览器以及操作系统等信息
* @userAgent    含以下属性中所有或一部分的字符串：appCodeName,appName,appVersion,language,platform
* @appCodeName  与浏览器相关的内部代码名
* @appName      浏览器的正式名称
* @appVersion   浏览器的版本号
* @language     浏览器支持的语言
* @platform     浏览器正在运行的操作系统平台，包括Win16(windows3.x) Win32(windows98,Me,NT,2000,xp),Mac68K(Macintosh 680x0)
* */
var userAgent = navigator.userAgent.toLowerCase(); //转换为小写字母
var is_opera = (userAgent.indexOf('opera') != -1); //判断浏览器是否为opera browser
var is_saf = ((userAgent.indexOf('applewebkit') != -1) || (navigator.vendor == 'Apple Computer, Inc.')); //is Mac OS browser
var is_webtv = (userAgent.indexOf('webtv') != -1);  //高性能新型电视机
var is_chrome = (userAgent.indexOf('Chrome') != -1); // is Google browser
var is_ie = ((userAgent.indexOf('msie') != -1) && (!is_opera) && (!is_saf) && (!is_webtv) && (!is_chrome)); //is IE browser
var is_ie4 = ((is_ie) && (userAgent.indexOf('msie 4.') != -1)); //ie4
var is_ie6 = is_ie&&!window.XMLHttpRequest; //ie6
var is_ie9 = is_ie&&!!document.documentMode&&document.documentMode==9; //ie9
var is_ie8 = is_ie&&!!document.documentMode&&!is_ie9; //ie8
var is_ie7 = (is_ie&&!is_ie6&&!is_ie8&&!is_ie9)||(is_ie&&document.documentMode==7); //ie7
var is_moz = ((userAgent.indexOf('gecko')!=-1) && (!is_saf)); //gecko
var is_kon = (userAgent.indexOf('konqueror') != -1); //KDE  linux browser
...
<div id='lv' value='77'>
var a = $('id');
console.log(a.attributes['value'].nodeValue);
*/
function $(id){
...
demo
 var a = $('id');
 var b = $c('ll',a);
 console.log(b[0].value='56')
*/
//parentobj 父标签,tag 当前class标签类别
